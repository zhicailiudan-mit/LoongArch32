...
# The CPU currently uses clk_50M as its only real clock. Do not force
# CLOCK_DEDICATED_ROUTE on optimized button/unused-clock nets.
...
# CPU and SRAM communicate only through XPM asynchronous FIFOs.  Although
# both clocks originate in the same PLL, their frequency/phase relationship
# is not part of the ready/valid protocol and must not create 0.625 ns
# inter-clock setup/hold requirements.  Keep the two SRAM clocks together;
# sram_wclk is the phase-shifted write strobe used by sram_ctrl.
set cpu_domain_clock [get_clocks -of_objects \
    [get_pins u_clk_pll/inst/plle2_adv_inst/CLKOUT0]]
set sram_domain_clocks [get_clocks -of_objects \
    [get_pins {
        u_clk_pll/inst/plle2_adv_inst/CLKOUT2
        u_clk_pll/inst/plle2_adv_inst/CLKOUT3
    }]]
set_clock_groups -asynchronous \
    -group $cpu_domain_clock \
    -group $sram_domain_clocks

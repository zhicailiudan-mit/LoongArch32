...
module DispatchQueue #(
    ...
    // Do not let a younger Store consume the last SQ credit while an older
    // Store is still waiting in the DQ.  This keeps the registered candidate
    // boundary while preventing a full SQ of younger Stores from deadlocking
    // the older ROB head.
